...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ACLPATTERN']._serialized_end = 497
    _globals['_ACLOPERATION']._serialized_start = 500
    _globals['_ACLOPERATION']._serialized_end = 861
    _globals['_ACLPERMISSIONTYPE']._serialized_start = 864
    _globals['_ACLPERMISSIONTYPE']._serialized_end = 1010